...
const designLabels = extractLabels("diseño");
...
export const ProjectCalc = forwardRef((props, ref) => {
    ...
    const calculateSubtotal = () => {
        ...
        const modulosPrice = values.modulos * prices["Módulos"];
        const botsPrice = values.bots * prices["Bots"];
    ...
    useImperativeHandle(ref, () => ({
        getOrder: () => ({
            ...
            labels: {
                ...
                modulos: values.modulos > 0 ? `${values.modulos} Módulos` : '0 Módulos',
    ...
    return (
        ...
        <div className=" flex-wrap flex-justify-center flex-align-end  w-100 py-8 Q_xs_py-0">
            <div className=" w-100 w-max-300px flex-col">
                <RangeInput emoji={!values.dominio ? null : <>🌐</>} label={getLabelFromArray(values.dominio, dominioLabels)} name="dominio" min={0} max={dominioLabels.length - 1} value={values.dominio} handleChange={handleChange} />
                ...
                <RangeInput emoji={!values.modulos ? null : <>📦</>} label={values.modulos > 0 ? `${values.modulos} Módulos` : '0 Módulos'} name="modulos" min={0} max={50} value={values.modulos} handleChange={handleChange} />
            ...
            <div className="flex-col w-min-300px ">
                ...
                <div className="Q_xs_pb-8 w-100 flex-col">
                    ...
                    <RangeInput label={"Tiempo: "+getLabelFromArray(values.tiempo, tiempoLabels)} name="tiempo" min={0} max={tiempoLabels.length - 1} value={values.tiempo} handleChange={handleChange} noborder style={{filter:"invert(1)", color: "white"}}  />
