...
<div className='h-min-90vh pt-100 flex-col w-100 '>
          ...
          <div className='Q_xs tx-lx tx-altfont-1 tx-bold-8 w-max-700px px-4'>Tecnología de la información</div>
            ...
            <div className='tx-altfont-1 w-max-600px py-1 w-100 '>
              <div className='px-4 '>
              <div className="Q_xs">  El análisis forense de datos es esencial para cualquier empresa que busque protegerse contra el fraude.</div>
              
                  <div className="Q_sm_x">   El análisis forense de datos es esencial para cualquier empresa que busque protegerse contra el fraude y otros delitos informáticos.</div>
              </div>
            </div>
            <div className='tx-altfont-1 w-max-600px py-1 w-100 '>
...
export const AboutUsRecoveryLLL = () => {
  return (<>
<div className='h-min-90vh pt-100 flex-col w-100 '
...
>
        ...
        <div className='Q_xs tx-lx tx-altfont-1 tx-bold-8 w-max-700px px-4'>Tecnología de la información</div>
          ...
          <div className='py-4'></div>
          <div className='tx-altfont-1 w-max-600px py-1 w-100 '>
            <div className='px-4'>El análisis forense de datos es esencial para cualquier empresa que busque protegerse contra el fraude<div className="Q_sm_x"> y otros delitos informáticos</div>.</div>
          </div>
          <div className='tx-altfont-1 w-max-600px py-1 w-100 '>
            <div className='px-4'>Datos virtuales podrán ser presentados como pruebas electrónicas ante la justicia.</div>
          </div>
